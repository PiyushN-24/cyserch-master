...
import Thumbnail from "../../../../../public/images/Cloud-Application-Penetration-Testing-Report.jpg";
  ...
  return (
    <>
      <div className="bg-gray-100 h-[15vh] px-4 sm:px-36 flex flex-col justify-center items-center">
        <h1 className="text-3xl sm:text-5xl text-black font-medium">Cloud Applications</h1>
      ...
      <div className="w-full px-4 py-8 rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-6 rounded-lg text-white order-1 md:order-1">
            <h2 className="text-3xl mb-4">Download the Report to Uncover the Hidden Vulnerabilities in Cloud Applications.</h2>
            <br />
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="text-base mb-2">
                <strong className="font-bold">Identifying Common Cloud Vulnerabilities: </strong>
                Gain insights into typical security weaknesses found in cloud applications, including insecure APIs, misconfigured storage, and insufficient access controls.
              </li>
              <li className="text-base mb-2">
                <strong className="font-bold">Testing Methodologies: </strong>
                Understand the systematic approach Cyserch takes in cloud penetration testing, from initial reconnaissance to exploitation and reporting.
              </li>
              <li className="text-base mb-2">
            ...
            <div className="Form px-4 sm:px-8 md:px-16 lg:px-24 py-4 sm:py-6 md:py-8 lg:py-10">
              ...
              {isSubmitted ? (
                ...
                <form className="flex flex-col mt-10" onSubmit={handleSubmit}>
                  ...
                  <button
                    className="bg-[#01F2D2] text-[#0c1a2c] w-full py-3 rounded-lg mt-4 font-bold text-[1.2rem]"
                    type="submit"
