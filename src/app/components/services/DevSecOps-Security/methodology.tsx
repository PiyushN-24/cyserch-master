...
export default function Methodology() {
  return (
    <div className="bg-[#011c3c] flex flex-col md:flex-row items-center justify-between w-full px-6 md:px-12 lg:px-36 py-12 mt-16 sm:mt-0">
      <div className="w-full md:w-3/5 fadeLeft">
        ...
        {[
          ...
          <div key={index} className="bg-gray-600 p-6 rounded-lg text-gray-200 hover:bg-cyan-500 transition-colors duration-300">
