    ...
    <div className="Testimonials">
      ...
      <div className="testimonial-cards">
        ...
        <div className="testimonial-card">
          ...
          <p className="text-[#A39D9D] text-[1.2rem] font-light mt-4">
            Cyserch's DevSecOps expertise has been a game-changer for our organization. Their proactive security measures and continuous integration of security checks have greatly reduced vulnerabilities and improved our deployment cycles.
          </p>
          <div className="flex items-center mt-4">
            <div className="testimonial-img"></div>
            <div className="testimonial-info">
