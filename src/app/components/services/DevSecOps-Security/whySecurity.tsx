    ...
    <div className="px-4 sm:px-[9rem] py-4 sm:py-[3rem]">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 p-4 sm:p-[3rem]">
        <div className="flex flex-col items-center justify-start w-full sm:w-1/3 h-[25rem] sm:h-[22rem] rounded-lg bg-[#011c3c] p-4">
          ...
          Embed security into your CI/CD pipelines with our Continuous Integration Security service. Our experts implement automated security checks, ensuring that vulnerabilities are detected and addressed early in the development process, reducing risks and enhancing overall security.
          </p>
        </div>
        <div className="flex flex-col items-center justify-start w-full sm:w-1/3 h-[25rem] sm:h-[22rem] rounded-lg bg-[#011c3c] p-4">
          <div className="flex gap-3 items-center">
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-1/3 h-[25rem] sm:h-[22rem] rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
          Stay compliant with industry standards and regulations through our Compliance Monitoring. We continuously review your development practices and deployments to ensure adherence to security policies and compliance requirements, safeguarding your organization from potential legal and regulatory issues.
          </p>
        </div>
      </div>
    </div>
