    ...
    <div className="px-4 sm:px-[9rem] py-4 sm:py-[3rem]">
      ...
      <div className="cards flex flex-col sm:flex-row gap-4 sm:gap-8 p-4 sm:p-[3rem]">
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-1/4 h-[27rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Get tailored recommendations for implementing automated security tools that fit your development and deployment processes, ensuring continuous scanning and threat detection.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-1/4 h-[27rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Choose from various roadmap options designed to align with your organization's specific needs and budget, ensuring a strategic approach to embedding security into your DevOps practices.
          </p>
        </div>
      ...
      <div className="cards flex flex-col sm:flex-row gap-4 sm:gap-8 p-4 sm:p-[3rem]">
        <div className="flex flex-col items-center justify-start w-full sm:w-96 h-[22rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Ensure a thorough evaluation of your DevSecOps pipeline, identifying potential security gaps across all stages of development, from planning to deployment.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-96 h-[22rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Provide detailed metrics and analysis on your security posture, including vulnerability statistics, threat detection rates, and recommendations for improving overall security efficiency.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-96 h-[22rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Deliver a high-level overview for executives, highlighting the security performance of your DevSecOps practices, key areas of concern, and strategic recommendations.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-start w-full sm:w-96 h-[22rem] border rounded-lg bg-[#011c3c] p-4">
          ...
          <p className="text-[#a39d9d] text-lg font-light leading-normal mt-3 mb-2">
            Assist your team in refining DevSecOps practices, implementing security improvements, and adapting to emerging threats to maintain a robust security posture.
          </p>
        </div>
      </div>
    </div>
