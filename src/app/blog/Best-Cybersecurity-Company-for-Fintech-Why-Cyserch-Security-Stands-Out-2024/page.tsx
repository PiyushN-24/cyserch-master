...
<div className="text-white grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
  ...
  <div className="bg-gray-800 rounded-lg p-4">
    ...
    <a href="https://www.cyserch.comiam" className="text-blue-500 hover:underline">Learn more</a>
  </div>
  <div className="bg-gray-800 rounded-lg p-4">
...
<div className="rounded-lg p-4">
  ...
  <ul className="text-white list-disc list-inside space-y-2 mb-6 text-sm sm:text-base md:text-lg font-light">
    ...
    <li><a href="https://www.example.com/comprehensive-cybersecurity-guide" className="text-blue-500">External Guide: Comprehensive Cybersecurity Guide</a></li>
    <li><a href="https://www.example.com/whitepaper-fintech-security" className="text-blue-500">Whitepaper on Fintech Security: In-depth analysis of fintech security challenges and solutions</a></li>
  </ul>
</div>
