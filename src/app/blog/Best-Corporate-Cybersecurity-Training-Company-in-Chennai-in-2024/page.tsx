...
export const metadata = {
  ...
  description: "Discover the top corporate cybersecurity training companies in Chennai for 2024, with a special emphasis on why Cyserch stands out.",
};
  ...
  return (
    <div className="px-8 sm:px-16 md:px-24 lg:px-32 xl:px-48 py-4">
        ...
        <div className="bg-gray-800 p-4 mb-4 rounded-lg">
          ...
          <ul className="list-disc list-inside text-white text-sm sm:text-base md:text-lg font-light">
            <li>Tailored Training Programs: Customize content to fit your organization’s specific needs.</li>
            <li>Experienced Trainers: Learn from professionals with real-world experience.</li>
        ...
        <div className="bg-gray-800 p-4 mb-4 rounded-lg">
          ...
          <ul className="list-disc list-inside text-white text-sm sm:text-base md:text-lg font-light">
            <li>Interactive Learning: Engage in hands-on exercises and simulations.</li>
            <li>Diverse Curriculum: Covers a wide array of topics relevant to different industries.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-800 p-4 mb-4 rounded-lg">
          ...
          <ul className="list-disc list-inside text-white text-sm sm:text-base md:text-lg font-light">
            <li>In-depth Training: Extensive modules covering various aspects of cybersecurity.</li>
            <li>Client Testimonials: Positive feedback from a range of satisfied clients.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-800 p-4 mb-4 rounded-lg">
          ...
          <ul className="list-disc list-inside text-white text-sm sm:text-base md:text-lg font-light">
            <li>Advanced Tools: Utilizes the latest technology in training.</li>
            <li>Actionable Skills: Training that translates into real-world applications.</li>
          </ul>
        </div>
        ...
        <div className="bg-gray-800 p-4 mb-4 rounded-lg">
          ...
          <ul className="list-disc list-inside text-white text-sm sm:text-base md:text-lg font-light">
            <li>Flexible Solutions: Adaptable training schedules and formats.</li>
            <li>Comprehensive Content: Covers a wide range of cybersecurity topics.</li>
          </ul>
        </div>
        ...
        <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light">
          Ans: Corporate cybersecurity training educates employees about the latest threats and best practices for protecting sensitive information and systems.
        </p>
        <h3 className="text-white text-xl sm:text-2xl md:text-2xl font-semibold mb-2">
          Q2. How often should corporate cybersecurity training be conducted?
        </h3>
        <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light">
          Ans: Training should be conducted regularly, ideally on an annual basis, with additional sessions as needed to address emerging threats.
        </p>
        <h3 className="text-white text-xl sm:text-2xl md:text-2xl font-semibold mb-2">
          Q3. What are the certifications to look for in a training provider?
        </h3>
        <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light">
          Ans: Look for certifications such as Certified Information Systems Security Professional (CISSP), Certified Information Security Manager (CISM), and Certified Ethical Hacker (CEH).
        </p>
        <h3 className="text-white text-xl sm:text-2xl md:text-2xl font-semibold mb-2">
          Q4. How can I assess the effectiveness of the training?
        </h3>
        <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light">
          Ans: Assess effectiveness through metrics such as reduced security incidents, improved compliance, and feedback from participants.
        </p>
        <ContactUs />
      </div>
  );
