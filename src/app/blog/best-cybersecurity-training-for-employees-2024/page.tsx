    ...
    <div>
      ...
      <main>
        <div className="px-8 sm:px-16 md:px-24 lg:px-32 xl:px-48 py-4">
          ...
          <h3 className="text-white text-xl sm:text-3xl font-bold mb-2">Understanding Cyber Threats</h3>

          <h4 className="text-white text-xl sm:text-3xl font-bold mb-2">Phishing Attacks</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Malware and Ransomware</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Social Engineering</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h3 className="text-white text-2xl sm:text-3xl font-bold mb-2">Best Practices for Employees</h3>
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Strong Password Policies</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Recognizing Suspicious Activity</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Regular Software Updates</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
            Keeping software up-to-date is crucial for preventing vulnerabilities. Our training includes instructions on enabling automatic updates and the importance of patch management. For a step-by-step guide on updating software, check out this <a href="https://www.lifewire.com/how-to-update-software-4689340">resource</a>.
          </p>

          <h2 className="text-white text-2xl sm:text-3xl md:text-3xl font-bold mb-4">Implementing Cybersecurity Training Programs</h2>
          <h3 className="text-white text-2xl sm:text-3xl font-bold mb-2">Developing a Training Curriculum</h3>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h3 className="text-white text-2xl sm:text-3xl font-bold mb-2">Delivery Methods for Training</h3>
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Online Training Modules</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">In-Person Workshops</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
          ...
          <h4 className="text-white text-2xl sm:text-3xl font-bold mb-2">Ongoing Education and Refresher Courses</h4>
          <p className="mb-4 text-white text-sm sm:text-base md:text-lg font-light mt-2">
